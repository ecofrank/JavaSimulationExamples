...
public class Mover {
    ...
    void update() {
        DVector mouse = new DVector(surface.mouseX, surface.mouseY);
        DVector dir = DVector.getDiff(mouse, location); // Compute direction
        dir.normalize(); // normalize
        dir.mult(0.5);   // scale
        acceleration = dir; // this is new acceleration
